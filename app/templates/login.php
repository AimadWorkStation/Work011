<?php 
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		$stmt = $con ->prepare('select id,username,password from user where username = ? and password = ?');
...
<form class="login register ml-auto mr-auto" action="" >
		...
		<input class="form-control" type="text" id="fullname" placeholder="Full Name" autocomplete="off">
		<input class="form-control" type="password" id="pass" placeholder="Password" autocomplete="off">
